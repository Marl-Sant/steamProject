...
const SET_CURRENT_POST = 'posts/setCurrentPost';
...
export const populateRecentUserPosts =
  () => async (dispatch) => {
...
export const populateCurrentPost =
...
export const fetchPostsByProfile =
  (userId) => async (dispatch) => {
    const res = await fetch(
      `/api/communities/user/${userId}/posts`
    );
    if (res.ok) {
