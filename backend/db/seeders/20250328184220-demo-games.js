...
module.exports = {
  async up(queryInterface, Sequelize) {
    const appIdArray = [
      1151340, 1203620, 1627720, 2246340, 594330, 1361210,
      1086940, 1313140, 1222140, 601430, 1670870, 976310,
    ];
    ...
    const seedGameInformation = await Promise.all(
      appIdArray.map(async (id) => {
        ...
        seedGame['price'] = '59.99';
        seedGame['categories'] = base['categories'].map(
          (category) => {
        ...
        seedGame['screenshots'] = base['screenshots'].map(
          (image) => {
